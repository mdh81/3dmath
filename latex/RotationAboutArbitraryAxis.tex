...
\begin{document}
    ...
    \noindent{$V$ and $R$ are known quantities. $V'_{\perp}$ can be calculated by observing that $V'_{\perp}$ and $B$ and are two 
    mutually perpendicular plane vectors. Along with $R$ they describe a coordinate frame $V'_{\perp}BR$. $B$ can be calculated as 
    the mutally perpendicular vector} 
