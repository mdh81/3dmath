...
\begin{document}
    ...
    \paragraph \noindent In the clip coordinate space, the clipping volume is a cube of length 2. Coordinates of all points inside the clipping volume are in the range $[-1,1]$.\linebreak
